...
class HiveMindSystemRebootButton(ButtonEntity):
    ...
    def name(self):
        """Name of the entity."""
        return f"hm-reboot-button-{self._name}"
...
class HiveMindSystemShutdownButton(ButtonEntity):
    ...
    def name(self):
        """Name of the entity."""
        return f"hm-shutdown-button-{self._name}"
...
class HiveMindRestartButton(ButtonEntity):
    ...
    def name(self):
        """Name of the entity."""
        return f"hm-restart-button-{self._name}"
...
async def async_setup_entry(
    ...
    async_add_entities([connection_button, reboot_button, shutdown_button, restart_button])
